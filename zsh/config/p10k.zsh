...
() {
  ...
  function my_git_formatter() {
    ...
    local      clean='%F{#11111b}' # dark foreground
    local   modified='%F{#11111b}' # dark foreground
    local  untracked='%F{#11111b}' # dark foreground
    local conflicted='%F{#11111b}' # dark foreground
  ...
  ################[ Programmer palette (Catppuccin Mocha) — overrides everything above ]################
  # Pastel segment + dark text for location/git; dark segment + coloured text for tooling.
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    virtualenv pyenv node_version go_version rust_version java_version
    kubecontext time newline
  )
  local crust='#11111b' surf='#313244'
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$crust  POWERLEVEL9K_OS_ICON_BACKGROUND='#cba6f7'
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$crust  POWERLEVEL9K_DIR_BACKGROUND='#89b4fa'
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#45475a'
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$crust  POWERLEVEL9K_DIR_ANCHOR_BOLD=true
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND=$crust  POWERLEVEL9K_DIR_NOT_WRITABLE_BACKGROUND='#f38ba8'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$crust  POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#f38ba8'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=$crust  POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#f38ba8'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=$crust  POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND='#f38ba8'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=2
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$crust  POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#fab387'
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#94e2d5'  POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='#f9e2af'  POWERLEVEL9K_VIRTUALENV_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND='#f9e2af'  POWERLEVEL9K_PYENV_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND='#a6e3a1'  POWERLEVEL9K_NODE_VERSION_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND='#94e2d5'  POWERLEVEL9K_GO_VERSION_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND='#fab387'  POWERLEVEL9K_RUST_VERSION_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND='#f38ba8'  POWERLEVEL9K_JAVA_VERSION_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='#89b4fa'  POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=$surf
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$crust  POWERLEVEL9K_TIME_BACKGROUND='#b4befe'
