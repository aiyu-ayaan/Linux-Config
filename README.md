...
| [`gnome/`](gnome/README.md) | GNOME kit: dark theme, cursor, title buttons, workspaces (`ws-add` / `ws-close`), tiling, auto-hiding dock, genie minimise animation, touchpad gestures (touchegg), power, autostart entries. `gnome/apply.sh` reapplies it. |
